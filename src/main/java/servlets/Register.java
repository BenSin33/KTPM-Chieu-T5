...
public class Register extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        User user = new User(
                request.getParameter("email"),             // don't checked for null or empty
                request.getParameter("FName"),             //dont checked for null or empty
                request.getParameter("LName"),              //dont checked for null or empty
                request.getParameter("PhoneNumber"),        //dont checked for null or empty
                request.getParameter("ShippingAddress")     //dont checked for null or empty
        );
...
//            response.sendRedirect("home.jsp");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException { // 64 in checklist : 
